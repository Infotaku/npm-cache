...
module.exports = function (composerCommand) {
  ...
  var getComposerVersion = function () {
    var version = 'UnknownComposer';
    var versionString = shell.exec(composerCommand + ' --version', {silent: true}).output;
    // Example below:
