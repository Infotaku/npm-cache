...
module.exports = function (jspmCommand) {
  if (jspmCommand === undefined) {
    jspmCommand = 'jspm';
  }
  ...
  function getJspmVersion() {
    var rawMultilineOutput = shell.exec(jspmCommand + ' --version', {silent: true}).output;
  ...
  return {
    ...
    installCommand: jspmCommand + ' install',
