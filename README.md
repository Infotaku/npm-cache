...
npm-cache install --npmCmd  path/to/npm/command	# run the specified npm executable
npm-cache install --jspmCmd  path/to/jspm/command	# run the specified jspm executable
npm-cache install --composerCmd  path/to/composer/command	# run the specified composer executable
npm-cache install --bowerCmd  path/to/bower/command	# run the specified bower executable
